-- Adapted from PSVim/PSVim
-- Copyright (c) 2025, PSVim
-- License: Apache-2.0
---@class psvim.util.format
...
M.formatters = {} ---@type PSFormatter[]

---@param formatter PSFormatter
...
---@param buf? number
---@return (PSFormatter|{active:boolean,resolved:string[]})[]
